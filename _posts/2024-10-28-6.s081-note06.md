---
title: 6.s081-note06-interrupts
author: Sillycheese
date: 2024/10/28 18:00:27 +0800
categories:
  - MIT6.s081
tags:
  - xv6
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/6s081note06.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/20241028164702.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281705852.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281726412.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281737026.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281802444.png)

这里将所有的中断都设置在Supervisor mode，然后设置SIE寄存器来接收External，软件和定时器中断，之后初始化定时器。

接下来我们看一下main函数中是如何处理External中断。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281805272.png)

我们第一个外设是console，这是我们print的输出位置。查看位于console.c的consoleinit函数。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281805591.png)

这里首先初始化了锁，我们现在还不关心这个锁。然后调用了uartinit，uartinit函数位于uart.c文件。这个函数实际上就是配置好UART芯片使其可以被使用。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281807542.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281810271.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281812156.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281815929.png)

scheduler函数主要是运行进程。但是在实际运行进程之前，会执行intr_on函数来使得CPU能接收中断。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281817495.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281820765.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281822333.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281823251.png)

所以由Shell输出的每一个字符都会触发一个write系统调用。之前我们已经看过了write系统调用最终会走到sysfile.c文件的sys_write函数。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281824381.png)

这个函数中首先对参数做了检查，然后又调用了filewrite函数。filewrite函数位于file.c文件中。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281828589.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281835211.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281840720.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281847385.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281848493.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281906182.png)

plic_claim函数位于plic.c文件中。在这个函数中，当前CPU核会告知PLIC，自己要处理中断，PLIC_SCLAIM会将中断号返回，对于UART来说，返回的中断号是10。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281907534.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281908992.png)

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410281916671.png)
...
![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410282002888.png)

在我们的例子中，read函数就是console.c文件中的consoleread函数。

![](https://cdn.jsdelivr.net/gh/CheeseSilly/MyGallery@master/img/202410282003507.png)
